...
int main( void /* int argc, char* argv[]*/ ) {
    ...
    int size, function_type, exploration_type, menu, sinonimos, option, exit = 0, clave, i = 0;
...
while (exit == 0) {
    ...
    std::cout << "2: Insertar una clave" << std::endl;
    ...
    case 1:
        ...
        std::cin >> clave;
        if(tabla.Search(clave, max_iter) == true)
    ...
    case 2:
        std::cout << "Introduzca la clave: ";
        std::cin >> clave;
        if(tabla.Insert(clave, max_iter) == true)
