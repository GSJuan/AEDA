...
Ant *pant;
    ...
    std::cout << "Introduzca el tipo de la hormiga " << i+1 << " (0 = normal, 1 = invertida): ";
    std::cin >> ant_type;
    while ((ant_type < 0) || (ant_type > 1)) {
        std::cout << "El tipo de hormiga indicada no existe. Ojito Cuidado" << std::endl;
        std::cout << "Introduzca un tipo de hormiga válido (0 = normal, 1 = invertida):  " <<  std:: endl;
    std::cin >> ant_type;
    }
